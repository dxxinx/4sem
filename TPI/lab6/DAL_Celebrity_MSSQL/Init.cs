...
namespace DAL_Celebrity_MSSQL
{
	public class Init
	{
		...
		public static void Execute(bool delete = true, bool create = true)
		{
			...
			{
				Celebrity c = new Celebrity() { FullName = "Noan Chomsky", Nationality = "US", ReqPhotoPath = puri("Chomsky.jpg") };
			...
			}
			{
				...
				Lifeevent l1 = new Lifeevent() { CelebrityId = 7, Date = new DateTime(1938, 12, 28), Description = "Дата рождения", ReqPhotoPath = null };
